...
def main(argv: list[str] | None = None) -> int:
    ...
    args.out_dir = args.out_dir.expanduser().resolve() if args.out_dir is not None else None
    try:
...
def _run_one(binary: Path, *, args: argparse.Namespace, progress: Progress, out_dir: Path | None):
